              ...
              if (updateList.length == 0)
                showDialog<String>(
                  ...
                  builder: (BuildContext context) => AlertDialog(
                    ...
                    content: Text('Add new exercises to record this workout.'),
                    actions: <Widget>[
                      TextButton(
              ...
              ? Column(
                  children: [
                    ...
                    QuantityInput(
                        ...
                        step: 2.5,
                        onChanged: (value) => setState(() => weightInput =
                        ...
                        children: <Widget>[
                          Expanded(
                            child: MaterialButton(
                              color:
                                  exerciseCardTapped ? Colors.red : Colors.blue,
                              disabledColor: Colors.grey,
                              onPressed: () {
                                exerciseCardTapped
                                    ? setState(() {
                                        recordedExercises
                                            .removeAt(cardSelected);
                              ...
                              child: InkWell(
                                  onTap: () {
                                    setState(() {
                                      ...
                                      cardSelected = recordedExercises
                                          .indexOf(recordedExercise);
                                    });
                                  },
                                  child: ListTile(
                                    tileColor:
